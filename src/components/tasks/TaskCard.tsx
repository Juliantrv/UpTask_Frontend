...
export default function TaskCard({ task, canEdit }: TaskCardtProps) {
          ...
          >
            <MenuItems className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
              <MenuItem>
                <button
                  type="button"
                  className="block px-3 py-1 text-sm leading-6 cursor-pointer text-gray-900"
                  onClick={() =>
              ...
              {canEdit && (
                <>
                  ...
                  <MenuItem>
                    <button
                      type="button"
                      className="block px-3 py-1 text-sm leading-6 cursor-pointer text-red-500"
                      onClick={() => {
